...
Follow the sections from setup through the terminal chatbot.
"""
...
def clear_database():
    ...
    This function deletes all stored documents from the configured namespace.
...
# ============================================================================
# This section combines retrieval (Pinecone) with generation (CHAT_MODEL)
...
def chat_with_rag(user_question):
    ...
    3. Generate answer using the configured chat model
...
def run_chatbot():
    ...
    """
    print("\n" + "="*70)
    print(f"RAG CHATBOT - Powered by {CHAT_MODEL}")
    print("="*70)
...
# ============================================================================
# Running this file starts the terminal chatbot.
